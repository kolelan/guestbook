<?php /* Smarty version Smarty-3.1.14, created on 2019-07-19 12:40:24
         compiled from "/home/prg/PhpstormProjects/webasyst_guestbook/webasyst-framework/wa-system/page/templates/PageEdit.html" */ ?>
<?php /*%%SmartyHeaderCode:1241741265d3190087c88e5-42848945%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '15bf120e5801ca7e4da417e3b1f76a1f9e260653' => 
    array (
      0 => '/home/prg/PhpstormProjects/webasyst_guestbook/webasyst-framework/wa-system/page/templates/PageEdit.html',
      1 => 1560783480,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1241741265d3190087c88e5-42848945',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5d31900885cca4_99099274',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5d31900885cca4_99099274')) {function content_5d31900885cca4_99099274($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_wa_datetime')) include '/home/prg/PhpstormProjects/webasyst_guestbook/webasyst-framework/wa-system/vendors/smarty-plugins/modifier.wa_datetime.php';
...
<div class="dialog" id="s-switch-editor">
    ...
    <div class="dialog-window" style="height: 140px; min-height: 140px; width: 530px; min-width: 530px">
        <form>
            <div class="dialog-content">
                <div class="dialog-content-indent">
                    <b>Редактор WYSIWYG может изменить ваш HTML-код.</b><br><br>Это необходимо для правильного форматирования текста. Код Smarty может быть сломан, и устаревшие HTML-теги могут быть заменены на современные.<br><br>Вы действительно хотите переключиться на WYSIWYG-редактор?
                </div>
            </div>
            <div class="dialog-buttons">
                <div class="dialog-buttons-gradient">
